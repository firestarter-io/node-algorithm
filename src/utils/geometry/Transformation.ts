...
Transformation.prototype = {
	...
	transform: function (point: PointLiteral, scale: number) {
		// (Point, Number) -> Point
		return this._transform({ ...point }, scale);
	},

	// destructive transform (faster)
	_transform: function (point: PointLiteral, scale: number) {
		scale = scale || 1;
	...
	untransform: function (point: PointLiteral, scale: number): PointLiteral {
		scale = scale || 1;
		return {
